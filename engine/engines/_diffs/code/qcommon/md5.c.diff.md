# Diff: `code/qcommon/md5.c`
**Canonical:** `wolfcamql-src` (sha256 `dd752960d891...`, 9536 bytes)
Also identical in: ioquake3

## Variants

### `quake3e`  — sha256 `fefc94239fa9...`, 11592 bytes

_Diff stat: +297 / -191 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\md5.c	2026-04-16 20:02:25.223227700 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\quake3e\code\qcommon\md5.c	2026-04-16 20:02:27.304420300 +0100
@@ -17,10 +17,16 @@
 #include "q_shared.h"
 #include "qcommon.h"
...
### `openarena-engine`  — sha256 `bed22023ea16...`, 9541 bytes

_Diff stat: +3 / -3 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\md5.c	2026-04-16 20:02:25.223227700 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\openarena-engine\code\qcommon\md5.c	2026-04-16 22:48:25.909298600 +0100
@@ -78,7 +78,7 @@
 static void MD5Transform(uint32_t buf[4],
 	uint32_t const in[16])
 {
