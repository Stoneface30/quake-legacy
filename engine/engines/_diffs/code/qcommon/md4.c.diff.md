# Diff: `code/qcommon/md4.c`
**Canonical:** `wolfcamql-src` (sha256 `d5f9af02d49f...`, 5137 bytes)

## Variants

### `quake3-source`  — sha256 `fc5be3df4b9c...`, 10443 bytes

_Diff stat: +243 / -153 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\md4.c	2026-04-16 20:02:25.223227700 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\quake3-source\code\qcommon\md4.c	2026-04-16 20:02:19.960609700 +0100
@@ -1,207 +1,297 @@
-/*
-	mdfour.c
...
### `ioquake3`  — sha256 `088e43d56098...`, 5137 bytes

_Diff stat: +2 / -2 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\md4.c	2026-04-16 20:02:25.223227700 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\ioquake3\code\qcommon\md4.c	2026-04-16 20:02:21.568107500 +0100
@@ -109,8 +109,8 @@
 		M[i] =
 			((uint32_t)in[i*4+3] << 24) |
 			((uint32_t)in[i*4+2] << 16) |
...
### `quake3e`  — sha256 `2c1caa2cad7f...`, 5161 bytes

_Diff stat: +6 / -6 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\md4.c	2026-04-16 20:02:25.223227700 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\quake3e\code\qcommon\md4.c	2026-04-16 20:02:27.304420300 +0100
@@ -101,7 +101,7 @@
 	m->A = A; m->B = B; m->C = C; m->D = D;
 }
...
### `openarena-engine`  — sha256 `47791d69dc0c...`, 5082 bytes

_Diff stat: +8 / -9 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\md4.c	2026-04-16 20:02:25.223227700 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\openarena-engine\code\qcommon\md4.c	2026-04-16 22:48:25.909298600 +0100
@@ -106,11 +106,8 @@
 	int i;
