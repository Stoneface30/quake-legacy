...
ROOT = Path(r"G:/QUAKE_LEGACY/engine/engines/variants")
OUT  = Path(r"G:/QUAKE_LEGACY/engine/engines")
MAN  = OUT / "_manifest"
...
def main():
    ...
    with (MAN / "DELETE_READY.md").open("w", encoding="utf-8") as f:
        ...
        f.write("Canonical tree is built at `engine/engines/_canonical/` plus\n")
        f.write("per-tree variant dirs at `engine/engines/<tree>/`.\n\n")
        f.write("## Statistics\n\n")
        ...
        f.write("ls G:/QUAKE_LEGACY/engine/engines/_canonical/\n")
