...
# THE PARSER VERSION a corpus was built with (engine/parser/corpus_status.py).
#   1  everything before 2026-09-12.
#   2  gate G1 (2026-09-12): the engine's own decoder and this parser agree on
#      every field. Fixed: stale delta-reference history, full frames seeding
#      baselines, entering entities skipping their baseline, fields changed
#      to zero, repeated reliable commands, bcs0/1/2, '%' and high bytes in
#      strings, signed playerstate fields, persistant/ammo/powerups.
# Entity-derived data from a corpus built below 2 is STALE_PRE_PARSER_V2.
PARSER_VERSION = 2
