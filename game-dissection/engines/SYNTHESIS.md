...
- `_docs/wolfcamql-src/` — ARCHITECTURE, EXTENSION_POINTS, PROTOCOL_LAYER, CLIENT_SERVER_SPLIT, RENDERER_NOTES, QUIRKS
- `_docs/q3mme/` — same 6
- `_docs/quake3e/` — same 6

### Light treatment (3 docs each) — reference only
- `_docs/quake3-source/` — ARCHITECTURE, EXTENSION_POINTS, QUIRKS
- `_docs/ioquake3/` — same 3
- `_docs/uberdemotools/` — same 3
- `_docs/quake1-source/`, `quake2-source/`, `darkplaces/`, `yamagi-quake2/`
- `_docs/openarena-engine/`, `openarena-gamecode/`
- `_docs/wolfet-source/`, `demodumper/`, `qldemo-python/`, `q3vm/`, `gtkradiant/`
- `_docs/wolfcamql-local-src/` (nearly identical to wolfcamql-src, doc just notes deltas)
