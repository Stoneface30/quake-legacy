# Diff: `code/qcommon/ioapi.c`
**Canonical:** `wolfcamql-src` (sha256 `c031146a0865...`, 11392 bytes)

## Variants

### `ioquake3`  — sha256 `22a043c0995e...`, 3933 bytes

_Diff stat: +3 / -183 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\ioapi.c	2026-04-16 20:02:25.222226900 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\ioquake3\code\qcommon\ioapi.c	2026-04-16 20:02:21.568107500 +0100
@@ -11,7 +11,7 @@
 #include <string.h>
...
### `openarena-engine`  — sha256 `8059719d8e8f...`, 3941 bytes

_Diff stat: +4 / -184 lines_

```diff
--- G:\QUAKE_LEGACY\tools\quake-source\wolfcamql-src\code\qcommon\ioapi.c	2026-04-16 20:02:25.222226900 +0100
+++ G:\QUAKE_LEGACY\tools\quake-source\openarena-engine\code\qcommon\ioapi.c	2026-04-16 22:48:25.909298600 +0100
@@ -10,8 +10,8 @@
 #include <stdlib.h>
 #include <string.h>
